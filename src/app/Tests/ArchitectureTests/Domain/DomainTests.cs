...
namespace Budgetter.ArchitectureTests.Domain;
...
public class DomainTests : TestBase
{
    ...
    public void Entity_Which_Is_Not_Aggregate_Root_Cannot_Have_Public_Members()
    {
        ...
        foreach (var type in types)
        {
            ...
            if (publicFields.Any() || publicProperties.Any()) failingTypes.Add(type);
        }
    ...
    public void Entity_Should_Have_Parameterless_Private_Constructor()
    {
        ...
        foreach (var entityType in entityTypes)
        {
            ...
            if (!hasPrivateParameterlessConstructor) failingTypes.Add(entityType);
        }
